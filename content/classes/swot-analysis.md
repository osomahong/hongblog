...
보고서나 기획안에 SWOT 표를 넣어야 해서 네 칸을 채워 본 적이 있을 겁니다. 강점에 `품질 우수`, 약점에 `인지도 부족`, 기회에 `시장 성장`, 위협에 `경쟁 심화`를 적고 나면 표는 완성됩니다. 그런데 다음 주에 무엇을 해야 하는지는 그대로 비어 있습니다.
...
네 항목에 담당자와 기한, 목표 숫자를 붙이면 그대로 [KPI](/class/marketing-strategy-frameworks/what-is-kpi) 후보가 됩니다. 목표값을 무엇을 근거로 정하는지는 [마케팅 KPI 설정 총정리](/insights/marketing-kpi-setting-guide)에 채널별 예시와 함께 적어 두었습니다.
...
그래서 SWOT 하나로 전략을 끝내지 않습니다. 시장을 나누고 대상을 고르는 일은 [STP](/class/marketing-strategy-frameworks/stp-strategy)가 맡습니다. 교차 전략에서 뽑은 항목에는 [KPI](/class/marketing-strategy-frameworks/what-is-kpi)를 걸어 목표값과 기간을 붙이고, 분기 방향을 정할 때는 [OKR](/class/marketing-strategy-frameworks/what-is-okr)의 Objective로 올려 둡니다. SWOT은 상황을 점검하는 틀이고 목표를 관리하는 일은 다른 틀이 맡습니다.
