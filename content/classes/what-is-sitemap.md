...
1. **사이트맵은 사이트의 페이지 주소를 모아 검색엔진에 제출하는 목록입니다.** 크롤러가 링크를 따라가지 않고도 주소를 알 수 있게 해 주는 지름길입니다.

2. **건물 1층의 층별 안내판과 같습니다.** 작은 건물에서는 없어도 되지만, 층이 많고 복도가 복잡하면 안쪽 사무실이 오래도록 발견되지 않습니다.
