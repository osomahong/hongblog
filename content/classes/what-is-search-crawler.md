...
앞 강에서 본 발견, 저장, 표시 가운데 **첫 단계인 발견을 담당하는 것**이 이번 강의 주제입니다.
...
여기서 오해가 자주 생깁니다. 크롤러는 인터넷 전체를 훑어보지 않습니다. **자기가 아는 주소만 방문합니다.** 주소를 알 방법이 없으면 그 페이지는 검색엔진에게 없는 것이나 마찬가지입니다.

## 📮 골목을 도는 우편배달부

<div style="overflow-x:auto; margin:1.5rem 0;">
  <div style="max-width:100%; border:3px solid #000; background:#fff;">
    <div style="background:#FFD700; border-bottom:3px solid #000; padding:10px 16px; font-weight:700;">배달부가 새 집 주소를 알게 되는 경로</div>
    <div style="padding:16px;">
      ...
      <div style="border:3px solid #000; background:#F3F3F3; padding:8px 12px; margin-bottom:8px;"><strong>2</strong> 주민센터에 붙은 세대 명단을 확인합니다<span style="color:#FF0000; font-weight:700;"> = 사이트맵</span></div>
      ...
      <div style="border-top:3px solid #000; margin-top:14px; padding-top:10px; font-size:0.85em; color:#555;">셋 중 어느 것도 없으면 배달부는 그 집을 영영 모릅니다.</div>
    </div>
  </div>
</div>
...
배달부의 습관에도 특징이 있습니다. 우편물이 자주 오가는 집은 매일 들르고, 몇 달째 아무것도 없는 집은 점점 뜸하게 갑니다. 구글도 크롤링 예산 문서에서 인기가 높거나 자주 바뀌는 주소를 더 자주 방문한다고 설명합니다.
...
세 경로는 서로를 대신하지 못합니다. 사이트맵에 주소를 올려 두어도 어디서도 링크되지 않은 페이지는 발견이 늦어질 수 있습니다. **링크가 먼저이고 사이트맵은 그것을 거드는 수단입니다.**
...
같은 사이트에서 한쪽은 환영하고 한쪽은 막는 상황이 동시에 벌어집니다. 데이터를 모으는 쪽 크롤링은 [웹 크롤링](/class/digital-basic/what-is-web-crawling) 강에서 별도로 다룹니다.
...
1. **검색엔진 크롤러는 링크를 따라다니며 페이지를 찾아 읽어 오는 프로그램입니다.** 인터넷 전체를 훑는 것이 아니라 자기가 아는 주소만 방문합니다.

2. **골목을 도는 우편배달부와 같습니다.** 이웃이 알려 주거나, 주민센터 명단에 오르거나, 집주인이 직접 등록해야 새 집을 알게 됩니다. 셋 다 없는 페이지는 발견되지 않습니다.
