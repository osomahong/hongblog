...
1. 메타 어드밴티지+ 앱 캠페인은 입찰과 타겟, 노출 위치를 Meta AI에 맡기고 광고주는 소재와 목표, 예산만 정하는 방식입니다.

2. 타겟을 직접 고를 수 없어서 어떤 소구점의 소재를 넣느냐가 누구에게 보일지를 정하고 소재는 한 번에 최대 50개까지 넣을 수 있습니다.

3. 시작하려면 메타 SDK나 MMP로 설치와 앱 안 행동이 전달돼야 하고 피드 광고는 같은 사용자에게 반복 노출돼 소재가 빨리 닳습니다.
