...
summary3:
  ...
  - '명령은 지금 있는 폴더를 기준으로 돌아가므로 명령이 듣지 않을 때는 pwd로 현재 위치부터 확인합니다.'
  - 'npm과 git 같은 개발 도구 대부분이 터미널에서 돌아가고 sudo는 시스템 설정을 바꿀 수 있으므로 이유를 모르면 쓰지 않습니다.'
---
...
- **개발 도구 대부분이 CLI 기반입니다.** [npm](/class/vibe-coding-basics/what-is-npm), git, docker 등 개발에 필요한 핵심 도구들은 모두 터미널에서 실행됩니다.
