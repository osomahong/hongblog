...
1. 디버깅은 코드에서 난 오류의 원인을 찾아 고치는 과정입니다.

2. 에러 메시지에는 오류 종류와 문제가 난 파일, 줄 번호가 함께 적혀 있어서 맨 윗줄부터 읽으면 어디를 볼지 정해집니다.

3. 브라우저 쪽 오류는 F12 개발자 도구의 Console과 Network 탭에서 보이고 서버 쪽 오류는 npm run dev를 실행한 터미널에 찍힙니다.
