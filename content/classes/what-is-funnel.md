...
quiz:
  - options:
    ...
    question: >-
      광고 캠페인 결과를 분석했더니, 노출 50,000회 대비 클릭 2,500회(CTR 5%)로 양호했지만, 클릭 후 구매 전환은
      25건(CVR 1%)으로 매우 낮았습니다. 퍼널 관점에서 가장 적절한 개선 방향은?
    explanation: >-
      CTR 5%는 양호하므로 광고 소재(TOFU→MOFU)는 잘 작동하고 있습니다. 문제는 클릭 후 구매까지의
...
summary3:
  ...
  - '인지를 넓히는 TOFU와 비교를 돕는 MOFU, 구매를 밀어 주는 BOFU마다 과금 방식과 타겟을 다르게 잡습니다.'
  - '노출 10만에서 클릭 3,000이 나오고 장바구니 400에 구매 120이라면 클릭에서 장바구니로 가는 14퍼센트 구간이 병목입니다.'
---
