...
summary3:
  - '애드 프러드는 가짜 클릭과 가짜 설치로 광고비를 빼가는 부정행위이고 손해의 큰 부분은 이미 일어난 설치의 공적을 가로채는 데서 납니다.'
  - '부정행위는 진짜 설치의 공적을 가로채는 하이재킹과 기기와 이벤트를 처음부터 만들어 내는 스푸핑으로 나뉩니다.'
  - '클릭에서 첫 실행까지 걸린 시간인 CTIT가 몇 초 안쪽에 몰리면 클릭 인젝션, 며칠씩 늘어지면 클릭 스팸을 의심합니다.'
---
