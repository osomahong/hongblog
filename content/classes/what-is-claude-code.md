...
metaTitle: 'Claude Code CLI 뜻과 시작 방법'
metaDescription: >-
...
1. Claude Code는 앤트로픽이 만든 에이전트형 코딩 도구로 코드베이스를 직접 읽고 고치며 명령까지 실행합니다.

2. 터미널과 VS Code, JetBrains, 데스크톱 앱, 웹이 같은 엔진을 쓰기 때문에 환경을 옮겨도 쓰는 방법이 같습니다.

3. 테스트 작성과 의존성 업데이트 같은 반복 작업을 맡기고 커밋과 PR 생성까지 git 안에서 이어서 처리합니다.
