...
quiz:
  - options:
    ...
    explanation: OAuth의 가장 큰 보안상 장점은 우리 서버에 비밀번호를 저장하지 않아도 된다는 점입니다. 비밀번호 관리(암호화, 유출 방지, 재설정 기능 등)는 보안의 큰 부담인데, Google이나 GitHub 같은 대형 서비스에 이 책임을 위임할 수 있습니다. 바이브코딩처럼 보안 전문 지식이 부족한 상황에서 특히 유용한 방식입니다.
    correctIndex: 1
---
