...
summary3:
  - 'ROI는 투자한 총비용 대비 순이익의 비율이고 순이익을 투자 비용으로 나눈 뒤 100을 곱해 구합니다.'
  - 'ROAS는 광고비와 매출만 보지만 ROI는 인건비와 원가, 운영비까지 넣고 이익을 기준으로 봅니다.'
  - '그래서 ROAS가 400퍼센트로 나와도 원가와 인건비를 넣고 다시 계산하면 ROI가 마이너스인 경우가 있습니다.'
---
...
이런 질문의 궁극적인 답이 바로 **ROI**입니다.

## 🔑 ROI, 한마디로 뭘까요?

**ROI(Return On Investment)**는 **투자한 비용 대비 얼마의 순이익을 얻었는지**를 나타내는 지표입니다.
...
**예산 보고에서 "그래서 남는 돈은 얼마냐"라는 질문을 받았을 때**
...
- 광고를 집행한 뒤 매출 그래프는 올라가는데 정산 후 잔고는 거의 늘지 않는 경우가 있습니다. 매출에서 원가, 판매 수수료, 배송비, 광고비를 순서대로 빼 보면 순이익이 거의 0에 가깝다는 사실이 드러납니다. 이때 계산한 것이 바로 ROI입니다. 광고 관리 화면의 ROAS만 보고 있으면 이 상태를 몇 달씩 모르고 지나칠 수 있습니다.
