...
[LTV](/class/digital-marketing-terms/what-is-ltv)처럼 고객 한 명이 남기는 값을 다룰 때도 같은 기준을 씁니다. 총 회수액을 따질 때는 평균 LTV가 맞고, 새 고객 한 명이 어느 정도를 남길지 가늠할 때는 중앙값 쪽이 덜 부풀려진 값입니다. 지표별 계산식은 [마케팅 지표 계산 공식](/insights/marketing-metrics-formula-guide)에 모아 두었습니다.
...
10만 원 이상 주문은 4건뿐이지만 평균을 끌어올리는 것은 이 4건입니다. 평균 객단가를 [KPI](/class/marketing-strategy-frameworks/what-is-kpi)로 걸어 둔 팀이라면 목표값을 정하기 전에 이 표부터 그려 보는 편이 안전합니다.
