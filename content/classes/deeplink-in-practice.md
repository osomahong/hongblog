...
1. 딥링크 실전 구축은 링크를 누른 사람의 설치 여부와 기기를 판별해 미설치자는 스토어로 보내고 설치자는 앱 안 화면까지 연결하는 작업입니다.

2. 일반 딥링크는 설치를 마친 사용자를 홈 화면에 떨어뜨리지만 디퍼드 딥링크는 첫 실행에서 원래 보려던 화면까지 데려갑니다.

3. 무료로 쓰이던 파이어베이스 다이나믹 링크는 2025년 8월 25일 종료됐고 그날 이후 기존 링크도 동작하지 않으므로 문자와 QR에 뿌린 옛 링크부터 점검합니다.
