...
quiz:
  - question: 광고비를 많이 쓴 달에 매출도 높았고 두 숫자의 상관계수가 0.9로 나왔습니다. 이때 맞는 판단은 무엇일까요?
    ...
    correctIndex: 0
    explanation: >-
      상관계수는 두 숫자가 얼마나 비슷하게 움직였는지만 알려 주고 어느 쪽이 원인인지는 알려 주지 않습니다. 매출이 잘 나온 달에 예산을
...
- **둘 다 답하지 못하는 것**: 한쪽이 다른 쪽의 원인인지는 두 방법 어느 쪽도 알려 주지 않습니다
...
상관계수는 -1에서 1 사이의 값으로 나옵니다. 부호와 절댓값이 서로 다른 것을 알려 줍니다.
...
상관계수는 두 지표가 얼마나 닮게 움직였는지만 알려 주고 얼마나 늘어나는지는 알려 주지 않습니다. 광고비와 전환 수의 상관계수가 0.9라고 해도 광고비를 10만 원 더 썼을 때 전환이 몇 건 느는지는 그 숫자에 없습니다. 그 답을 식으로 만드는 방법이 회귀분석입니다.
...
여기서 못박아 둘 점이 하나 더 남습니다. **회귀식이 나왔다고 광고비가 전환의 원인이라고 증명되지는 않습니다.** 위 표의 다섯 주가 성수기로 갈수록 예산을 늘린 기간이었다면, 이 식은 광고의 효과가 아니라 성수기 수요를 그려 놓은 것에 가깝습니다. 식은 두 숫자가 어떤 모양으로 함께 움직였는지를 요약할 뿐이고, 원인의 방향은 앞에서 정리한 방법으로 따로 확인해야 합니다.

## 📈 설명력(결정계수) 읽는 법

회귀식과 함께 결정계수라는 숫자가 따라 나옵니다. 기호로는 R²로 적고 0에서 1 사이의 값입니다.

**결정계수는 이 식이 전환 수의 오르내림 가운데 몇 퍼센트를 설명하는지 나타낸 값입니다.** 위 예에서 0.94가 나왔다면 주마다 달라진 폭의 94%는 광고비로 설명되고 나머지 6%는 이 식 밖의 요인이라는 뜻입니다.
...
|---|---|---|
| 광고비와 전환 수의 관계 | 예산을 늘렸을 때 [전환](/class/digital-marketing-terms/what-is-cvr)이 따라오는 모양과 그 폭 | 예산을 성과에 맞춰 조정해 왔다면 원인과 결과가 뒤바뀐 상태입니다 |
...
바로 늘리기보다 작게 시험하는 쪽이 안전합니다. 지역이나 기간을 절반으로 나눠 한쪽만 예산을 올리고 나머지와 비교하면, 함께 움직인 관계인지 실제로 밀어 올린 관계인지 나뉩니다. 이 절차 없이 상관계수만 근거로 예산을 늘리면 시즌 수요가 만든 숫자에 돈을 맞추게 됩니다.
