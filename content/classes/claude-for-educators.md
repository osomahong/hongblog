...
quiz:
  - question: 수업 자료를 만들 때 Claude를 효과적으로 쓰려면 가장 먼저 무엇을 정해야 할까요?
    ...
    correctIndex: 0
    explanation: >-
      교육 자료의 품질은 형식보다 기준에서 결정됩니다. 학생 수준(초, 중급, 고급), 수업 톤(존댓말, 친근체), 자료
      형식(슬라이드, 워크북, 퀴즈) 의 기준을 먼저 명시한 수업 가이드를 만들어두면 Claude가 매번 같은 결의 자료를 생성합니다.
      모델, 언어, 입력 방식은 그 다음 단계의 변수입니다.
metaTitle: '교사, 강사를 위한 클로드 활용법: 수업 자료와 평가'
metaDescription: '교육 종사자를 위한 클로드 활용은 수업 자료 제작, 학생 평가, 커리큘럼 설계에 Claude를 쓰는 방법입니다. 교사와 강사가 바로 적용할 수 있는 사례를 정리했습니다.'
