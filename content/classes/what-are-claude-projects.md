...
term: 클로드 프로젝트(Claude Projects) 활용하기
definition: >-
...
quiz:
  - question: 마케터가 매주 같은 형식의 광고 리포트를 정리하고 싶을 때 Projects를 어떻게 활용하면 가장 효율적일까요?
    ...
    correctIndex: 0
    explanation: >-
      Projects는 같은 자료, 지시, 대화 기록을 묶어두는 작업 공간입니다. 매주 반복되는 작업의 공통 자료(가이드라인, 샘플,
      형식)를 한 번 넣어두면 매주 새 데이터만 추가해 일관된 결과를 빠르게 받을 수 있습니다. 이 패턴은 [Claude
