...
18GB를 받는 동안 기다립니다. 이 컴퓨터에서는 40분쯤 걸렸습니다. 회선에 따라 달라집니다.
...
애플 실리콘은 메모리 하나를 CPU와 GPU가 나눠 씁니다. 창고 하나를 두 사람이 함께 쓰되 한쪽이 채울 수 있는 칸수가 정해져 있듯, macOS는 **GPU에 내줄 수 있는 몫에 한도**를 둡니다. 기본값은 대략 전체의 75%이고, 24GB 기기에서는 약 18GB입니다.
...
- **같은 작업을 아주 많이 반복**할 때입니다. 토큰 요금이 쌓이는 구간에서는 전기값이 더 쌉니다.
