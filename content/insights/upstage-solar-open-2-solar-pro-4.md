...
title: '업스테이지 Solar Open 2, Solar Pro 4 정리: 벤치마크와 연동법'
excerpt: >-
...
summary3:
  - >-
    Solar Open 2는 업스테이지가 2026년 7월 22일 가중치까지 공개한 250B 규모의 오픈웨이트 모델이고 Solar Pro 4는
    8월 6일 API로만 낸 상용 모델입니다.
  - >-
    공식 벤치마크에서 MMLU-Pro 86.2와 LiveCodeBench v6 92.4로 1위를 기록했지만 비교군이 어느 급인지 함께 봐야
    합니다.
  - 개인이 Solar Open 2를 직접 돌리려면 H200 4장이라는 최소 조건부터 따져 봅니다.
---

Solar Open 2는 업스테이지가 2026년 7월 22일 가중치까지 공개한 250B 규모의 [오픈웨이트](/insights/k2-horizon-fully-open-source-vs-open-weight) 언어 모델입니다. Solar Pro 4는 같은 회사가 2026년 8월 6일 API로 공개한 상용 모델이고, 이쪽은 가중치를 공개하지 않았습니다. 2주 남짓한 간격으로 성격이 다른 두 모델이 나왔고, 그 사이에 정부의 [독자 AI 파운데이션 모델 사업 2차 평가](/insights/sovereign-ai-foundation-model-2nd-evaluation)가 걸려 있습니다.
