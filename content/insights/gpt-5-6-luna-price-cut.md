...
title: 'GPT-5.6 Luna 가격 80% 인하 정리: 인하 폭, 배경, 경쟁 구도'
excerpt: >-
...
summary3:
  - >-
    오픈AI는 2026년 7월 30일 출시 3주 만에 GPT-5.6 Luna의 API 가격을 80퍼센트 내려 입력 100만 토큰당
    0.20달러로 잡았습니다.
  - '100만 토큰은 영어 단어 약 75만 개로 A4 1,500장 분량인데 이를 읽히는 비용이 우리 돈으로 300원 정도입니다.'
  - 출시 3주 만에 값을 5분의 1로 내린 것은 벤치마크 점수 경쟁이 가격 경쟁으로 옮겨 가고 있다는 신호로 보입니다.
---
...
- **최상위 구간**: Sol(출력 $30.00)은 Claude Opus 5(출력 $25.00)보다 여전히 비쌉니다. 최상위 구간에서는 가격보다 성능으로 승부하겠다는 구도로 보입니다.
