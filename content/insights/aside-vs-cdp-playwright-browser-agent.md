...
title: 'Aside(어사이드)와 Playwright MCP, 클로드 인 크롬 차이 정리'
excerpt: >-
...
metaTitle: 'Aside(어사이드)와 Playwright MCP, 클로드 인 크롬 차이 정리'
metaDescription: >-
  Aside는 크로미움 엔진을 직접 고쳐 에이전트를 브라우저 안에 넣은 AI 브라우저입니다. CDP로 바깥에서 붙는 Playwright
...
- **운영체제 조건**: Aside는 오랫동안 macOS 전용이었고 2026년 9월에 윈도우판이 정식 출시됐습니다. 받는 방법과 설치 후 사용법은 [Aside 브라우저 윈도우 다운로드와 설치 후 해볼 것](/insights/aside-browser-windows-install-guide)에 정리했습니다. 다만 도움말의 지원 사양은 아직 맥 기준이라 윈도우 쪽 정보는 얇은 편입니다.
