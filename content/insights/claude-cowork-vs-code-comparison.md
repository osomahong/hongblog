...
ogImage: https://avqz4vnz10fk0ilw.public.blob.vercel-storage.com/illustrations/claude-cowork-vs-code-comparison-0-1771421680577.png
...
클로드 코드(Claude Code)는 **터미널에서 동작하는 개발자용 AI 에이전트**입니다. 코워크가 데스크톱 앱의 GUI(그래픽 사용자 인터페이스)에서 동작한다면, 코드는 개발자가 익숙한 **CLI(명령줄 인터페이스)**에서 동작합니다.
