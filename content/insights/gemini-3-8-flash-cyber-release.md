...
title: '제미나이(Gemini) 3.8 플래시와 3.8 플래시 사이버 공개, 달라진 점과 가격 정리'
excerpt: >-
...
highlights:
  ...
  - >-
    ...
    잡습니다.
metaTitle: '제미나이(Gemini) 3.8 플래시와 플래시 사이버 공개, 달라진 점과 가격'
metaDescription: >-
  제미나이 3.8 플래시(Gemini 3.8 Flash)는 구글이 2026년 9월 2일 공개한 코딩과 에이전트 작업용 모델입니다. 3.7
...
### 제미나이 3.8 플래시 가격은 얼마인가요?

100만 토큰당 입력 0.75달러, 출력 3.75달러입니다. 3.7 플래시와 같은 단가입니다. 다만 이 값은 2026년 12월 31일까지의 도입가이고, 2027년 1월 1일부터 입력 1.50달러와 출력 7.50달러로 두 배가 됩니다. 내년 예산은 정가로 잡아야 계산이 맞습니다.

### 3.7 플래시에서 3.8로 바로 옮겨도 되나요?

작업 종류에 따라 다릅니다. 코딩과 문서 분석은 벤치마크가 오른 영역이라 시험해 볼 만합니다. 반대로 요약이나 분류처럼 추론이 깊지 않은 대량 작업은 3.7을 남기는 편이 낫습니다. 3.8이 어려운 작업에서 토큰을 더 쓰는 설계라 같은 단가에도 청구액이 올라갈 수 있기 때문입니다.

### 단가가 같은데 왜 비용이 달라지나요?

단가가 아니라 사용량에서 달라집니다. 3.8은 어려운 문제에 더 많은 토큰을 쓰도록 설계돼 있어서, 같은 요청이라도 출력 토큰이 늘어납니다. 옮기기 전에 같은 작업 20건 정도를 두 모델로 돌려 결과 품질과 청구 토큰을 함께 보는 편이 안전합니다.

### 3.8 플래시 사이버는 누구나 쓸 수 있나요?

쓸 수 없습니다. 페어윈드 프로그램 신청을 거친 기관만 접근할 수 있습니다. 정부 기관과 기반시설 운영자, 소프트웨어 유지관리자가 대상입니다. 일반 개발자 계정으로는 열리지 않습니다.
## Sources
