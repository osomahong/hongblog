...
title: '구글 옴니(Gemini Omni) 장점과 사용법, 다른 모델과 어떤 점이 다를까요?'
excerpt: >-
  구글 옴니(Gemini Omni)는 글, 이미지, 소리, 영상을 한 번에 입력받아 소리까지 붙은 영상을 만들어 내는 통합 멀티모달
  모델입니다. 대화로 영상을 고치는 방식과 Veo 3.1과의 차이, 사용처와 요금을 공식 데모 영상과 함께 정리했습니다.
category: AI_TECH
tags:
  - AI
  - 자동화
...
ogTitle: '구글 옴니 장점과 사용법, 다른 모델과 어떤 점이 다를까요?'
