...
title: '클로드(Claude) 커머스 에이전트 정리: 쇼핑 에이전트와 판매자 에이전트가 하는 일과 GA4 측정'
excerpt: >-
...
metaTitle: '클로드(Claude) 커머스 에이전트, 쇼핑과 판매자 에이전트와 GA4 측정'
metaDescription: >-
  클로드 커머스 에이전트(Claude Commerce Agents)는 앤트로픽이 2026년 9월 2일 공개한, 쇼핑 에이전트와 판매자
...
summary3:
  - >-
    클로드 커머스 에이전트는 앤트로픽이 2026년 9월 2일 공개한 청사진으로 쇼핑 에이전트와 판매자 에이전트, 업종별 예제 4종, 클로드
    코드 플러그인을 아파치 2.0 라이선스로 제공합니다.
  - >-
