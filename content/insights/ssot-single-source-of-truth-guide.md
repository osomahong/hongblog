...
excerpt: >-
  SSOT(Single Source of Truth)는 하나의 정보를 한곳에서만 고치고 나머지 곳은 전부 그곳을 참조하게 만드는 원칙입니다.
  데이터베이스 설계에서 나온 이 말이 지표 정의서와 노션 문서, 클로드 코드의 CLAUDE.md까지 이어지는 이유와 작은 팀에서 만드는 순서를
  정리했습니다.
category: AI_TECH
tags:
  - AI
