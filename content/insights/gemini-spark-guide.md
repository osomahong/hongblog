...
summary3:
  - '제미나이 스파크는 구글 클라우드의 전용 가상 머신에서 돌아가 노트북을 덮어도 맡긴 작업을 이어 가는 에이전트형 AI 비서입니다.'
  - 'Gmail과 캘린더, 드라이브를 읽어 맥락을 가져오므로 지난주 받은 견적서 같은 표현을 그대로 알아듣습니다.'
  - '2026년 8월 기준 한국어 앱에도 베타로 들어왔고 결제처럼 민감한 작업은 확인 단계를 남겨 두는 편이 안전합니다.'
---
...
주의할 점도 있습니다. 이 연결은 기본으로 해제돼 있고, 어떤 앱을 연결할지는 사용자가 직접 고릅니다. 회사 계정이라면 관리자가 조직 단위로 제미나이의 구글 앱 접근을 사용 설정하거나 해제할 수 있으므로, 항목이 보이지 않을 때는 관리자 설정을 확인해야 합니다.
...
- **활동 저장이 사용 설정돼 있어야 합니다**: 이 설정을 꺼 두면 커스텀 앱 연결이 막힙니다.
...
**2026년 9월 4일 기준으로는 아직 어렵습니다.** 공식 도움말이 밝힌 조건이 까다롭습니다.

- 미국에서만 열렸고 그 안에서도 일부 지역은 제외입니다
- 만 18세 이상이어야 합니다
- 영어로만 됩니다
- 모바일 앱과 gemini.google.com에서만 됩니다
- 순차 배포 중이라 조건을 갖춰도 아직 안 보이기도 합니다

요금제는 구글 AI 프로와 울트라가 대상입니다. 국내 계정에서 사진 정리를 시켰는데 반응이 없다면 구독 등급보다 지역과 언어 조건을 먼저 확인하는 편이 빠릅니다.
...
여기서 학생 요금제를 스파크와 이어서 생각하기 쉬운데, 둘은 바로 연결되지 않습니다. 구글은 2026년 8월 20일부터 대학생에게 유료 요금제를 1년 무료로 제공하지만, 한국을 포함한 미국 밖 시장의 학생이 받는 것은 Google AI Plus입니다. 스파크는 AI Ultra가 기준이고 미국에서만 AI Pro로도 열리므로, 학생 무료 혜택으로 스파크를 쓰려던 계획이라면 미리 확인하는 편이 좋습니다.

> 제미나이 스파크는 Google AI Ultra 기준으로 제공되고 미국에서는 AI Pro로도 열리며, Google AI Plus에는 포함되지 않습니다.
