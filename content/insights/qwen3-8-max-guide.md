...
title: 'Qwen3.8-Max 정리: 사양, 가격, 0902 업그레이드, 오픈웨이트 공개 상태 (2026년 9월 기준)'
excerpt: >-
...
highlights:
  - >-
    9월 2일 나온 0902판은 API 전용이고 허깅페이스에 올라온 가중치는 8월 8일자 Qwen3.8-2.4T-A95B이므로, 자체 서버에서 돌리는
    판과 API로 쓰는 판이 다르다는 점을 감안해 계획을 세웁니다.
  - '벤치마크 표는 알리바바가 직접 낸 수치이므로, 실제로 반복하는 작업 한두 개를 같은 조건으로 돌려 비교한 뒤 판단하는 편이 낫습니다.'
metaTitle: 'Qwen3.8-Max 정리: 사양, 가격, 0902 업그레이드 (2026년 9월 기준)'
metaDescription: >-
...
ogTitle: 'Qwen3.8-Max 정리: 사양과 가격, 0902 업그레이드 (2026년 9월 기준)'
ogDescription: >-
...
quiz:
  - question: 2026년 9월 2일 나온 Qwen3.8-Max-0902에서 바뀐 것과 바뀌지 않은 것으로 맞는 설명은 무엇일까요?
    ...
    correctIndex: 0
    explanation: >-
      QwenCloud 공식 모델 페이지는 0902를 qwen3.8-max의 업그레이드 스냅샷으로 설명하고, 100만 토큰 컨텍스트와 사고 모드,
      입력 2달러와 출력 6달러 가격을 그대로 둡니다. 허깅페이스의 Qwen 계정에는 2026년 9월 3일 기준 8월 8일자 Qwen3.8-2.4T-A95B만
      있고 0902판 저장소는 없습니다.
summary3:
  - 'Qwen3.8-Max는 알리바바 Qwen 팀이 2026년 8월 3일 공개한 2조 4천억 파라미터 MoE 모델이고 토큰당 950억을 활성화합니다.'
  - '가격은 100만 토큰당 입력 2달러에 출력 6달러로 직전 세대의 2.50달러와 7.50달러보다 약 20퍼센트 내렸습니다.'
  - '9월 2일 나온 Qwen3.8-Max-0902는 가격을 그대로 두고 코딩과 협업 작업을 추가 학습한 API 전용 판이고, 허깅페이스 가중치는 8월 8일자 2.4T-A95B에 별도 라이선스가 붙어 있습니다.'
---
