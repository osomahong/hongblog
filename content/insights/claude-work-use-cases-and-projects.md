...
title: 클로드(Claude) 업무 활용 사례 4가지와 프로젝트 설정법 정리
excerpt: >-
...
quiz:
  - question: 클로드 프로젝트에 지시사항을 따로 적어 두는 이유는 무엇일까요?
    ...
    correctIndex: 0
metaTitle: 클로드(Claude) 업무 활용 사례 4가지와 프로젝트 설정법 정리
metaDescription: >-
  클로드 업무 활용은 같은 자료와 지시사항을 프로젝트에 묶어 두고 반복 업무를 맡기는 방식입니다. 반복 보고서, 문서 정리, 회의록 정리, 팀
  공유 4가지 업무 활용 사례와 설정 순서를 공식 문서 기준으로 정리했습니다.
ogDescription: >-
...
summary3:
  ...
  - >-
    프로젝트 하나에 200K 컨텍스트가 주어지고 유료 플랜은 한도에 가까워지면 RAG가 작동해 처리 용량을 최대 10배까지 넓히며 무료
    계정은 프로젝트를 5개까지 만듭니다.
---
