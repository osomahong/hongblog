...
클로드 업무 활용은 같은 자료와 지시사항을 프로젝트에 묶어 두고 반복 업무를 맡기는 방식입니다. 클로드를 업무에 쓰기 시작하면 대부분 여기서 달라집니다. 매번 새 대화를 열고 처음부터 상황을 설명하는 사람과, 한 번 정리해 둔 자리 위에서 바로 일을 시작하는 사람으로 나뉩니다.
