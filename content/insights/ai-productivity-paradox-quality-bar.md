...
- **겉만 그럴듯한 산출물**: 형식은 갖췄지만 내용이 비어 있는 [결과물](/insights/meat-proxy-meaning-origin)이 팀 안을 돌아다니면서, 받은 쪽이 다시 만드는 시간이 생깁니다. 한 연구는 이런 일이 한 건 생길 때마다 대략 두 시간이 재작업으로 들어간다고 봤습니다.
...
- 남기지 않던 [작업 기록과 설명 문서](/insights/ai-era-three-debts)를 남깁니다
- 안 짜던 검증 절차를 짭니다
