...
title: 'LLMO 뜻과 SEO와의 차이: 개념, 작동 방식, 적용 순서'
excerpt: >-
...
이 용어가 아직 자리를 잡지 못한 상태라는 점을 먼저 말해 두겠습니다. LLMO, GEO, AEO는 업계에서 서로 다른 범위로 쓰이고 있고, 세 용어를 사실상 같은 뜻으로 쓰는 자료도 많습니다. 그래서 이 글은 용어 정의보다 **생성형 엔진이 문서를 고르는 순서**와 **그 순서에 개입할 수 있는 지점**을 중심에 두고 정리했습니다. 2026년 8월 기준입니다.
