...
한 팀이 이 표의 지표를 전부 들고 가지는 않습니다. **지금 가장 막혀 있는 단계 하나를 고르고 그 단계의 후행 지표 하나와 선행 지표 하나로 시작하는 편**이 낫습니다. 어디가 막혔는지는 단계별 전환율을 곱해 보면 드러납니다. 방문에서 상세 조회가 40%, 상세에서 장바구니가 12%, 장바구니에서 결제가 55%라면 고칠 곳은 가운데 단계입니다.
