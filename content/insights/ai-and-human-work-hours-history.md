...
title: 'AI 발전과 인간의 노동 시간: 자동화 역사가 남긴 단서'
excerpt: >-
  세탁기는 가사노동을 줄여줄 줄 알았지만 빨래 시간은 오히려 늘었다고 합니다. 산업혁명의 기계도, 케인스의 주 15시간 노동 예측도 결과는
  달랐습니다. AI는 다를까요. 자동화의 역사에서 조심스럽게 짚어보았습니다.
category: AI_TECH
tags:
  - AI
  - 자동화
...
highlights:
  ...
  - >-
    ...
    살펴볼 필요가 있습니다
metaTitle: 'AI 발전과 인간의 노동 시간: 자동화 역사가 남긴 단서'
metaDescription: >-
  자동화가 노동시간을 줄여 줄지는 아직 단정하기 어렵습니다. 세탁기 보급 이후의 가사노동, 제번스 패러독스, 케인스의 주 15시간 예측이 어긋난 배경을 정리하고, AI로 절약한 시간이 어디로 가는지와 개인이 해볼 수 있는 대응을 살펴봤습니다.
ogDescription: '세탁기, 산업혁명, 케인스의 노동시간 예측이 빗나간 이유. AI 시대의 노동시간 변화를 자동화의 역사에서 조심스럽게 짚어봤습니다.'
...
summary3:
  - '세탁기와 산업혁명, 케인스의 주 15시간 예측은 모두 노동시간이 줄어들 것으로 봤지만 실제로는 그렇게 되지 않았습니다.'
  - 코완의 분석에서 미국 가정의 주당 가사노동 시간은 20세기 초 약 52시간에서 중반 56시간으로 오히려 늘어난 흐름이 보입니다.
  - >-
    효율이 오르면 총사용량이 늘어난다는 제번스 패러독스가 노동에서도 반복돼 왔고 AI 시대에도 비슷한 흐름이 나타날 가능성이 적지 않아
    보입니다.
---
...
물론 자동화가 항상 노동시간을 늘린다고 보기는 어렵습니다. 다만 효율이 높아진 자원을 찾는 사회적 수요가 함께 폭발할 때 이런 현상이 자주 관찰돼 왔습니다. 빨래나 정보 처리, 콘텐츠 생산처럼 "더 많이 할 수만 있다면 더 하고 싶은" 활동에서 특히 강하게 나타나는 경향이 있습니다.
...
> 2030년이 임박한 지금, 케인스가 부를 두고 내놓은 예측은 큰 틀에서 맞은 부분이 있습니다. 노동시간 예측은 빗나간 것으로 평가됩니다.
...
- **소비 기준의 상승**: 1930년 평균인의 생활 수준이면 충분했지만, 사람들은 그 수준에 멈추지 않았습니다. 더 큰 집, 더 좋은 차, 더 다양한 경험을 원하면서 소비 기준이 함께 올라갔고, 노동시간을 줄일 동기가 약해진 흐름이 있습니다.
...
세탁기, 산업혁명, 케인스의 예측은 같은 메시지를 보내고 있는 것 같습니다. 효율을 높여주는 도구가 등장했을 때, 그 절약된 시간이 자동으로 여가나 휴식으로 가지는 않는 경향이 있다는 점입니다. 새로운 기준과 새로운 요구가 그 빈틈을 채우는 흐름이 자주 관찰됐습니다.
...
- **'AI로 더 많이 할 수 있다'는 압박을 의식하기**: AI 활용이 새로운 평가 기준이 되면 결과물의 양과 속도가 [새로운 표준](/insights/ai-productivity-paradox-quality-bar)이 될 수 있습니다. 이는 외부에서 오는 압박이며, 본인의 능력 부족이 아닐 가능성이 큽니다.
- **시간 절약과 시간 회수를 구분하기**: AI가 시간을 절약해주는 것과, 그 절약된 시간이 본인에게 돌아오는 것은 다른 문제일 수 있습니다. 후자를 위해서는 의식적인 경계 설정이 도움이 됩니다.

그렇다면 AI를 적게 쓰는 것이 답인지 궁금할 수 있지만, 그렇게 보기는 어렵습니다. AI를 쓰지 않으면 같은 결과물을 만드는 데 더 많은 시간이 들기 때문에 결과적으로 더 손해일 수 있습니다. 핵심은 AI를 쓰되, 절약된 시간을 본인의 의도대로 쓰려는 시도를 함께 하는 것에 가깝습니다.

> 효율이 높은 도구가 늘 일을 줄여주지는 않을 수 있습니다. 일이 줄어들기 위해서는 도구만이 아니라 그 시간을 어떻게 쓸지 정하는 의지가 함께 필요합니다.

AI는 분명 많은 것을 해결해주고 있습니다. 코드 작성, [데이터 분석](/class/data-analytics-basics/what-is-data-analysis), 콘텐츠 생성, 이메일 정리 같은 작업을 빠르게 처리해줍니다. 그 결과로 인간이 일을 안 하게 될지에 대해서는 단정하기 어렵지만, 자동화의 역사를 보면 신중하게 살펴볼 이유가 있어 보입니다.
...
### 세탁기가 가사노동 시간을 늘렸다고 봐도 되나요?

늘었다고 단정하기는 어렵고, 기대만큼 줄지 않았다고 보는 편이 정확합니다. 코완은 주당 가사노동이 20세기 초 52시간에서 중반 56시간으로 늘어난 흐름을 봤지만, 같은 기간을 주 70시간에서 30시간으로 줄었다고 추정한 연구자도 있습니다. 두 추정치는 차이가 크고, 겹치는 지점은 가전제품 보급률만큼 가사노동이 가볍게 줄지는 않았다는 부분입니다.

### AI를 덜 쓰면 일하는 시간이 줄어들까요?

그렇게 보기는 어렵습니다. AI를 쓰지 않으면 같은 결과물을 만드는 데 더 많은 시간이 들어서 오히려 손해가 될 수 있습니다. 자동화의 역사에서 문제가 됐던 지점은 도구를 쓴 사실이 아니라 도구가 만든 여유를 누가 어디에 쓰는지가 정해져 있지 않았다는 쪽에 가깝습니다.

### AI로 아낀 시간을 지키려면 무엇부터 하면 될까요?

그 시간의 용도를 미리 정해 두는 일이 먼저입니다. 30분이 비었을 때 쓸 곳을 정해 두지 않으면 다음 업무로 흘러가기 쉽고, 시간이 절약되는 것과 그 시간이 본인에게 돌아오는 것은 서로 다른 문제입니다. 결과물의 양과 속도가 새 기준이 되는 압박은 외부에서 오는 것이라 본인의 능력 문제로 받아들이지 않는 편이 낫습니다.
