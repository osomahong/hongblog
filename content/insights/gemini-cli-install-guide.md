...
summary3:
  - '제미나이 CLI는 구글이 Apache 2.0으로 공개한 오픈소스 터미널 AI 코딩 에이전트입니다.'
  - 'Node.js 20 이상이 깔려 있으면 npm 전역 설치 한 줄로 끝나고 구글 계정으로 로그인하면 바로 씁니다.'
  - '개인 구글 계정의 무료 한도는 하루 1,000회이고 API 키로 붙이면 250회로 줄어듭니다.'
---
