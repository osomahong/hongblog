...
1. **뉴스인지 아닌지는 글의 수명과 관계가 없어 보입니다.** 같은 날 올린 글 사이에서 성과가 100배까지 벌어졌는데, 오래 읽힌 글의 제목에는 사람들이 검색창에 그대로 치는 이름이 있었습니다.
2. **새 도구는 두 번째 업데이트가 나온 뒤에 봅니다.** 2쇄가 찍혔는지 확인하는 것과 비슷한 기준이고, 이 하나만으로 따라갈 목록이 눈에 띄게 줄어듭니다.
3. **이름과 방식을 나눕니다.** 이름은 바뀌지만 일하는 순서를 바꾸는 방식은 다음 도구로 옮겨 가므로, 하나를 끝까지 써 본 경험이 더 오래 남습니다.
