...
title: '퍼플렉시티 사용법: 검색 모드와 출처 확인, 요금제 정리'
excerpt: >-
...
metaTitle: '퍼플렉시티 사용법: 검색 모드, 출처 확인, 요금제 정리'
metaDescription: >-
...
summary3:
  ...
  - >-
    2026년 9월 15일 화면 기준 검색 모드는 검색, 심층 리서치, 모델 협의회, 단계별로 배우기 네 가지이고 모델을 직접 고르는
    기능은 월 20달러인 프로부터 열립니다.
  - >-
