...
title: 딥시크(DeepSeek) V4 프로 정식 출시와 100만 토큰 컨텍스트 가격 정리
excerpt: >-
...
metaTitle: 딥시크(DeepSeek) V4 프로 정식 출시와 100만 토큰 가격 정리
metaDescription: >-
...
summary3:
  ...
  - >-
    100만 토큰 컨텍스트를 100만 토큰당 0.435달러에 제공하지만 공식 가격표에 전반적인 인상 계획이 각주로 붙어 있어 장기 예산의
    전제로 삼기는 어렵습니다.
---
