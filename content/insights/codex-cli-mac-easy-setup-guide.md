...
metaDescription: >-
  맥에 OpenAI 코덱스 CLI를 설치하고 GPT-5.5 모델로 첫 작업을 시작하는 가이드입니다. 터미널, Homebrew, Node.js,
  npm 설치, ChatGPT 로그인, xhigh 추론 모드, 클로드 코드와의 차이까지 정리했습니다.
...
두 방식 중 어느 쪽을 써도 결과는 같습니다. 본 가이드에서는 npm 쪽을 메인으로 따라갑니다.
