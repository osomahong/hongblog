...
title: 메타 뮤즈 글리머(Meta Muse Glimmer) 로컬 실행 조건과 벤치마크 정리
excerpt: >-
...
metaTitle: 메타 뮤즈 글리머(Meta Muse Glimmer) 로컬 실행 조건과 벤치마크 정리
metaDescription: >-
...
quiz:
  - question: 뮤즈 글리머를 개인 컴퓨터에 받기 전에 가장 먼저 확인해야 할 것은 무엇일까요?
    ...
    explanation: >-
      ...
      순서입니다.
summary3:
  - 뮤즈 글리머는 메타가 2026년 8월 10일 Apache 2.0으로 공개한 파라미터 296억 개 로컬 에이전트 모델입니다.
  - '전체 정밀도판은 64GB, 압축판은 32GB와 24GB를 요구하며 성능 손실은 각각 0.2퍼센트와 1.0퍼센트입니다.'
  - >-
    24GB판은 RTX 4090이나 통합 메모리가 넉넉한 맥에서 돌아가고 도구를 부르는 작업은 앞서지만 터미널 작업은 같은 크기의
    Qwen3.6-27B에 뒤집니다.
---

뮤즈 글리머(Muse Glimmer)는 메타가 2026년 8월 10일 공개한 파라미터 296억 개 규모의 [오픈 웨이트](/insights/k2-horizon-fully-open-source-vs-open-weight) 에이전트 모델입니다. 가중치가 Apache 2.0 라이선스로 공개되어 있어 누구나 받아서 쓸 수 있습니다.
...
24GB는 RTX 4090이나 5090 같은 그래픽카드, 또는 [통합 메모리가 넉넉한 맥](/insights/qwen3-8-27b-local-mac)이 해당합니다. 통합 메모리를 쓰는 맥은 전체 용량 가운데 일부만 GPU 쪽으로 잡히므로, 32GB 맥에서 32GB 판을 그대로 돌리기는 어렵습니다.
