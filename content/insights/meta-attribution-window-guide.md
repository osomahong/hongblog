...
excerpt: 메타 광고의 '클릭 후 7일, 조회 후 1일'이 정확히 무엇을 뜻하는지 알고 계신가요? 같은 캠페인에서 전환 수가 다르게 보이는 이유를 4가지 시나리오 비교로 쉽게 설명합니다.
category: MARKETING
tags:
  - 마케팅 실무
  - 어트리뷰션
...
quiz:
  - options:
    ...
    explanation: '''클릭 후 7일''은 클릭한 시점부터 7일 이내의 모든 전환을 잡는 것입니다. 클릭 당일 전환도, 3일 뒤 전환도, 7일째 전환도 모두 포함됩니다. 따라서 ''클릭 후 7일'' 설정의 전환 수는 항상 ''클릭 후 1일'' 설정의 전환 수보다 같거나 많습니다.'
    correctIndex: 1
seriesSlug: digitalmarketing
seriesOrder: 10
metaTitle: 메타 어트리뷰션 윈도우 완벽 가이드 | 클릭 후 7일, 조회 후 1일 차이
metaDescription: 메타 광고의 '클릭 후 7일, 조회 후 1일' 어트리뷰션 윈도우가 정확히 무엇인지, 같은 캠페인에서 전환 수가 달라지는 이유를 4가지 시나리오 비교로 쉽게 설명합니다. 실무 설정 기준과 GA4와의 차이까지 정리했습니다.
