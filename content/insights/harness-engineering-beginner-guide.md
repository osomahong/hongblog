...
metaDescription: "AI 에이전트가 코드를 짜주는 시대, 사람의 역할은 '환경 설계'로 바뀌고 있습니다. 하네스 엔지니어링의 개념과 배경을 초보자 눈높이로 정리했습니다."
...
quiz:
  - question: "하네스 엔지니어링에서 '하네스(Harness)'가 의미하는 것은 무엇인가요?"
    ...
    correctIndex: 0
    explanation: "하네스(Harness)는 원래 말에 씌우는 마구를 뜻합니다. 요리에 비유하면 주방 환경, 레시피, 재료 목록, 검수 기준처럼 AI가 올바르게 일하도록 감싸는 모든 것을 의미합니다. AI 모델 자체가 아니라 모델을 둘러싼 시스템이 핵심입니다."
---
