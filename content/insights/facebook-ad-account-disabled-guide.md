...
아래는 광고계정이 비활성화됐을 때 실제로 나타나는 알림 화면입니다. 이 화면을 만나면서 상황이 시작됩니다. (출처: [LAH 블로그의 비활성화 경험담](https://projects.lahion.com/blog-104/))
...
아래는 계정 제한 상태를 확인하는 화면의 예시입니다. 제한 사항, 비활성화된 자산, 취할 수 있는 조치가 한 화면에 나옵니다. 이 캡처는 통합 전의 '계정 품질' 화면이라 지금의 비즈니스 지원 홈과 구성이 조금 다를 수 있지만, 확인하는 정보는 같습니다. (출처: [브런치 광고계정 비활성화 경험담](https://brunch.co.kr/@powerblog/54))

![계정 품질 화면의 계정 제한 상태. 계정 제한됨 표시와 함께 제한 사항 목록, 비활성화된 자산, 우측에 취할 수 있는 조치와 요청 계속 버튼이 표시된다](/images/insights/facebook-ad-account-disabled-guide/account-quality-dashboard.png)
...
검토 요청 버튼은 아래처럼 '취할 수 있는 조치' 영역에 나타납니다. 계정 상태에 따라 버튼이 비활성 상태로 보일 수도 있습니다. (출처: [LAH 블로그의 비활성화 경험담](https://projects.lahion.com/blog-104/))
