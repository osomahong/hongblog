...
<!-- 캡처 자리 1: 비활성화 알림 화면 (예: "회원님은 광고를 게재할 수 없습니다" 알림). 파일: /images/insights/facebook-ad-account-disabled-guide/disabled-notice.png -->
...
| 막힌 곳 | 상황 | 체감 심각도 |
|---------|------|------------|
| 광고 소재 | 특정 광고 1건만 거부. 나머지 광고는 정상 | 가장 가벼움 |
| 광고계정 | 해당 계정으로 광고 집행 불가 | 중간 |
| 페이지 | 해당 페이지를 광고에 사용 불가 | 중간 |
| 비즈니스 계정 또는 개인 계정 | 연결된 광고 자산 전체 접근 불가 | 가장 무거움 |
...
<!-- 캡처 자리 2: 비즈니스 지원 홈의 계정 상태 개요 화면. 파일: /images/insights/facebook-ad-account-disabled-guide/business-support-home.png -->
...
<!-- 캡처 자리 3: 검토 요청(Request review) 버튼 화면. 파일: /images/insights/facebook-ad-account-disabled-guide/request-review.png -->
