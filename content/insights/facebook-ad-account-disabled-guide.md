...
title: '페이스북(메타) 광고 계정 비활성화 대응: 확인 순서와 180일 시한'
excerpt: >-
...
metaTitle: '페이스북 광고 계정 비활성화 대응: 검토 요청 절차와 180일 시한'
metaDescription: >-
...
ogDescription: >-
  ...
  예방 조치까지 정리했습니다.
summary3:
  - '메타의 광고 제재는 광고 소재와 광고계정, 페이지, 비즈니스 계정 네 군데에 따로 적용되므로 어디가 막혔는지부터 확인합니다.'
  - 막힌 자산과 사유는 비즈니스 지원 홈에서 보고 위반이 없다고 판단될 때 검토 요청을 넣으며 검토는 보통 48시간 안에 끝납니다.
  - 막힌 직후 새 계정을 만들어 광고를 다시 돌리는 것은 메타가 금지하는 우회라서 멀쩡한 계정까지 연달아 막힙니다.
---
...
- □ [랜딩페이지](/class/digital-marketing-terms/what-is-landing-page)가 광고 내용과 다르거나, 팝업이 많거나, 다른 페이지로 여러 번 넘어간다
...
- □ 관리자 중에 2단계 인증을 사용 설정하지 않은 사람이 있다
...
| "아직도 월급만 받으세요?" | 소득 상태 암시 + 비하 | "부수입에 관심 있는 분들을 위한 클래스" |
...
| "혼자 사는 분을 위한" | 생활 상태 암시 | "1인 가구에 맞춘 소형 구성" |
...
참고로 2026년 3월부터 건강, 웰니스 광고 제한이 강화되고 [AI 생성 콘텐츠 표시 의무](/insights/claude-text-watermark-detection-limits)도 생겼습니다. 작년까지 잘 돌아가던 소재가 올해 걸리기 시작했다면 이런 정책 변화의 영향일 수 있습니다.
...
### 결제 문제로 막혔을 때도 검토 요청을 넣어야 하나요?

정산부터 확인하는 쪽이 먼저입니다. 메타 도움말 기준으로 결제 문제로 인한 비활성화는 미결제 금액을 정산하면 1시간에서 24시간 안에 풀리는 별도 경로가 있습니다. 결제 실패와 카드 한도, 선충전 카드 잔액을 함께 점검한 뒤에도 상태가 그대로일 때 검토 요청으로 넘어갑니다.

### 소재가 실제로 규정에 걸렸다면 검토 요청과 소재 삭제 가운데 무엇을 먼저 하나요?

소재를 내리는 쪽을 권하는 실무 의견이 많습니다. 검토 요청은 횟수에 제한이 있고 완료된 결정은 바꿀 수 없다고 공식 문서에 적혀 있어서, 위반이 분명한 소재에 요청을 쓰면 정작 필요한 건에 쓸 기회가 줄어듭니다. 규정에 걸리는 소재는 삭제하고, 정말 위반이 없다고 판단되는 건에만 요청을 씁니다.

### 광고계정이 막힌 다음에 백업 계정을 만들 수 있나요?

막힌 뒤에는 만들 수 없습니다. 광고계정이 비활성화되면 그 시점부터 새 광고계정을 만들지 못하기 때문에, 문제가 없을 때 비즈니스 관리자에서 생성 한도만큼 미리 만들어 두고 픽셀을 공유해 두는 방법이 실무에서 널리 권장됩니다. 막힌 직후에 새로 만들어 광고를 다시 돌리는 것은 메타가 우회 행위로 보는 대응이라 성격이 다릅니다.
