...
const LAB_TITLE = "트래픽 획득 보고서로 유입 채널 분석하기";
...
const DONE_TEXT =
  "Paid Search는 세션수가 세 번째로 많은데 참여율은 28.81%입니다. 광고비를 써서 들어온 사람 열에 일곱이 들어오자마자 나간다는 뜻입니다. Organic Social이 참여율은 더 낮지만 세션수가 1,684뿐이라 개선해도 늘어나는 참여 세션이 적습니다. 여기부터 개선합니다.";
