 ...
 * 잠재고객이 만든 시점부터 사람을 모으기 때문인데, 이 점을 모르면 조건을 수정하며 시간을 쓴다.
 *
...
const DONE_TEXT = `이제 조건에 맞는 사람이 모이는 대로 광고 계정으로 넘어갑니다. 지금 0명인 것은 조건이 틀려서가 아니라 어제 만들었기 때문입니다. 잠재고객은 만든 시점부터 사람을 모으고 지난 데이터로 채워 주지 않습니다. 오래전에 만든 ${OLD_AUDIENCE}가 4,820명인 것과 비교하면 그 차이가 보입니다.`;
