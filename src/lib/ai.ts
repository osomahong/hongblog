...
포스트만 읽어도 "맞아, 나도 그랬어"라고 느끼는 독립 콘텐츠를 만들어라.
그 공감 위에서 "이 주제를 더 깊이 다룬 글이 있다"고 자연스럽게 연결해라.
...
- 상대를 가르치거나 지적하지 마라. 같이 고민하는 사람이 되어라.
- "저도 이걸 몰라서 헤맸습니다", "돌이켜보니 그랬더라고요" 같은 겸손한 회고.
- "~하면 안 됩니다", "~를 모르면 위험합니다" 같은 경고/훈계조 금지.
- "~라고 생각했는데", "~해보니까 달랐습니다" 같은 발견의 톤을 써라.

== 구조 ==

[훅 — 1문장]
이 주제와 관련해 많은 사람이 한번쯤 느꼈을 솔직한 감정이나 순간.
잘 몰랐던 시절의 나를 떠올리며 써라. 도발이 아니라 공감이다.

(빈 줄)

[나의 경험 — 평문 5-7문장]
이 주제에 대해 처음엔 어떻게 생각했고, 어떤 계기로 관점이 바뀌었는지.
실패담이 아니라 성장 과정을 보여줘라.
"이런 경험, 다들 한번쯤 있지 않나요?" 하는 느낌으로 독자를 초대해라.
원문의 내용을 풀어쓰지 마라. 주제에 대한 보편적 경험을 새로 만들어라.

(빈 줄)

[깨달은 점 — 개조식 3-5항목]
경험을 통해 배운 것들을 "- " 접두어로 나열.
"이렇게 하지 않으면 안 된다"가 아니라 "이렇게 보니까 달랐다"는 톤.
누군가에게 유용한 관점 공유이지, 원문의 목차가 아니다.

(빈 줄)

[마무리 — 평문 2-3문장 + URL]
이 주제에 대해 더 체계적으로 정리한 글이 있다고 자연스럽게 연결.
"저도 정리하면서 많이 배웠습니다" 같은 겸손한 공유의 톤.
마지막 줄에 URL.
...
- 상대를 낮추거나 무지를 지적하는 표현 ("이것도 모르면", "아직도 ~하고 있다면")
- "~하면 안 됩니다", "~는 위험합니다" 같은 경고/훈계조
...
이 주제에 관심 있는 사람이라면 누구나 공감할 이야기를 써라.
포스트만 읽어도 "맞아, 나도 그랬어"라고 느끼는 독립 콘텐츠를 만들어라.
그 공감 위에서 "이 주제를 더 깊이 다룬 가이드가 있다"고 자연스럽게 연결해라.
...
[마무리 — 평문 2-3문장 + URL]
이 주제를 더 체계적으로 정리한 가이드가 있다고 자연스럽게 연결.
"저도 정리하면서 많이 배웠습니다" 같은 겸손한 공유의 톤.
마지막 줄에 URL.
