...
== 핵심 제약 ==
- 반드시 500자(공백·줄바꿈 포함) 이내. 절대 초과 금지.
...
(빈 줄)
3-4줄: 왜 이게 중요한지 실무 맥락으로 짧게 풀어라.
(빈 줄)
2-3줄: 글에서 다루는 접근법 힌트. 결론은 공개하지 마라.
(빈 줄)
1줄: ${data.url}
...
(빈 줄)
3-4줄: 왜 이 오해가 실무에서 문제가 되는지 짧게 풀어라.
(빈 줄)
2-3줄: 가이드가 바꿔주는 관점의 힌트만. 용어 나열 금지.
(빈 줄)
1줄: ${data.url}
