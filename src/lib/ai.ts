...
목표: 스크롤을 멈추고 "더 보기"를 눌러 끝까지 읽게 만든 뒤, 블로그 링크를 클릭하게 하는 것.

== 제약 ==
- URL 포함 총 1,000~1,300자.
- 한 줄에 한 문장. 의미 단락 사이 빈 줄.
- 마크다운 금지, 이모지 금지, 순수 텍스트만.
- 기술 용어 영어, 나머지 한국어.

== 톤 ==
- 지식을 나누는 실무자. 단정적이되 겸손하게.
- 1인칭 경험 기반. "저도 그랬습니다", "직접 겪어보니" 등.
- 독자가 "이 사람 진짜 해봤구나" 하고 신뢰하게 써라.

== 구조 ==

[훅 — 1문장]
스크롤을 멈추게 하는 한 줄. 도발, 반직관, 공감 중 택 1.
LinkedIn은 처음 2줄만 미리 보여준다. 이 한 줄이 전부다.

(빈 줄)

[서론 — 평문 3-5문장]
훅을 구체적으로 풀어라.
실무에서 흔히 겪는 실수나 오해를 생생하게 그려라.
숫자, 구체적 상황, 경험담을 넣어라.
추상적 설명 금지. 장면을 보여줘라.
...
[마무리 — 평문 2-3문장 + URL]
개조식 내용을 한 마디로 정리.
이 글이 무엇을 다루고 왜 읽어야 하는지 자연스럽게 연결.
마지막 줄에 URL.
...
- 원문 내용을 요약만 하는 행위. 독자적인 관점과 경험을 넣어라.
...
목표: 스크롤을 멈추고 "더 보기"를 눌러 끝까지 읽게 만든 뒤, 가이드 링크를 클릭하게 하는 것.
...
[마무리 — 평문 2-3문장 + URL]
개조식 내용을 한 마디로 정리.
이 가이드가 무엇을 다루고 왜 읽어야 하는지 자연스럽게 연결.
마지막 줄에 URL.
