...
export async function generateLinkedInSummary(data: {
  ...
  const prompt = `너는 LinkedIn에서 공감을 이끌어내는 실무자 콘텐츠 라이터다.

== 핵심 원칙 ==
이것은 블로그 글의 "요약"이 아니다.
원문의 주제를 소재로, 많은 사람이 공감할 수 있는 독립적인 SNS 콘텐츠를 만들어라.
LinkedIn 포스트 자체가 가치 있는 콘텐츠여야 한다.
읽는 사람이 "이거 나 얘기인데?" 하고 느끼게 쓴 뒤, 더 깊은 내용은 블로그에서 읽게 유도해라.

== 제약 ==
- URL 포함 총 1,000~1,500자.
- 한 줄에 한 문장. 의미 단락 사이 빈 줄.
- 마크다운 금지, 이모지 금지, 순수 텍스트만.
- 기술 용어 영어, 나머지 한국어.

== 톤 ==
- 동료에게 커피 한 잔 놓고 얘기하는 느낌.
- 1인칭 경험 기반이되 "나만의 이야기"가 아니라 "우리 모두의 이야기"로 확장해라.
- "저만 그런 게 아니었더라고요", "다들 한번쯤 겪어봤을 겁니다" 같은 공감 확장.

== 구조 ==

[훅 — 1문장]
많은 사람이 고개를 끄덕일 보편적 경험이나 감정을 건드려라.
"나도 저랬는데" 하고 멈추게 만드는 한 줄.

(빈 줄)

[공감 스토리 — 평문 5-7문장]
훅에서 던진 경험을 구체적으로 풀어라.
"나만 그런 게 아니라 많은 사람이 겪는 문제"라는 걸 보여줘라.
실무에서 실제로 일어나는 장면, 감정, 시행착오를 담아라.
독자가 자기 경험을 떠올리며 읽게 써라.
원문을 요약하지 마라. 원문 주제를 소재로 새로운 이야기를 만들어라.

(빈 줄)

[인사이트 — 개조식 3-5항목]
공감 스토리에서 자연스럽게 이어지는 깨달음이나 교훈.
"- " 접두어로 나열. 각 항목은 한 줄.
원문의 내용을 그대로 옮기지 말고, 실무자가 공감할 관점으로 재해석해라.
전부 공개하지 마라. "더 있는데..." 하는 느낌을 남겨라.

(빈 줄)

[마무리 — 평문 2-3문장 + URL]
"이런 생각을 정리해봤다" 또는 "더 깊이 파고든 글이 있다" 같은 톤으로
자연스럽게 블로그 글로 연결해라.
마지막 줄에 URL.
...
== 절대 금지 ==
- 원문 내용을 나열하거나 요약하는 행위 (가장 중요한 금지사항)
...
원문의 주제를 소재로, 많은 사람이 공감할 수 있는 독립적인 SNS 콘텐츠를 만들어라.
LinkedIn 포스트 자체가 가치 있는 콘텐츠여야 한다.
읽는 사람이 "이거 나 얘기인데?" 하고 느끼게 쓴 뒤, 더 깊은 내용은 가이드에서 읽게 유도해라.

== 제약 ==
- URL 포함 총 1,000~1,500자.
- 한 문장당 한 줄. 의미 단락 사이에 빈 줄.
- 마크다운 금지, 이모지 금지, 순수 텍스트만.
- 기술 용어는 영어, 나머지는 한국어.

== 톤 ==
- 동료에게 커피 한 잔 놓고 얘기하는 느낌.
- 1인칭 경험 기반이되 "우리 모두의 이야기"로 확장해라.
- "저만 그런 게 아니었더라고요", "다들 한번쯤 겪어봤을 겁니다" 같은 공감 확장.
...
[공감 스토리 — 평문 5-7문장]
훅에서 던진 경험을 구체적으로 풀어라.
이 분야에서 많은 사람이 겪는 혼란, 시행착오를 담아라.
독자가 자기 경험을 떠올리며 읽게 써라.
용어 정의를 나열하지 마라. 새로운 이야기를 만들어라.

(빈 줄)

[인사이트 — 개조식 3-5항목]
공감 스토리에서 이어지는 깨달음이나 교훈.
"- " 접두어. 각 항목은 한 줄.
실무자가 공감할 관점으로 재해석해라.
전부 공개하지 마라.
