...
const PAGE_DEFINITION =
  "GA4 Edu는 GA4와 같은 모양의 데모 화면을 순서대로 조작하며 사용법과 데이터 해석을 익히는 준이아빠블로그의 실습 코스입니다.";
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <section className="ga4-tut-section">
        ...
        <p className="ga4-p">
          ...
          파랑만 쓰기 때문에, 화면에 빨간색이 보이는 곳은 지금 누를 곳 하나뿐입니다.
        </p>
        <p className="ga4-p">
          어디를 누를지는 화면이 알려 주지만, 표를 어떻게 해석할지는 여러분이 직접 판단합니다.
          예를 들어 트래픽 획득 보고서를 다루는 초급 첫 편에서는 참여율이 가장 낮은 채널을
          고르라고 하지 않고, 세션수가 일정 규모를 넘는 채널 가운데 참여율이 가장 낮은 곳을
          고르게 합니다. 참여율 열만 보고 맨 아랫줄을 고르면 틀립니다. 버튼을 순서대로
          누르기만 해서는 끝까지 갈 수 없습니다.
        </p>
        <p className="ga4-p">
          화면에 나오는 숫자는 교육용으로 만든 가상 계정 준준상점의 데이터입니다. 실제 GA4 계정
          없이도 모든 조작을 해 볼 수 있고, 설정을 잘못 바꿔도 되돌려 놓을 걱정이 없습니다. GA4
          보고서는 가로가 넓어야 표를 다 볼 수 있습니다. 화면 오른쪽 위 화면 고정을 누르면 브라우저
