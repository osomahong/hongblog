---
name: ga4-analysis
description: GA4 데이터 분석 스킬. "GA4 분석", "트래픽 분석", "콘텐츠 성과", "애널리틱스", "이번 달 트래픽" 요청 시 트리거. GA4 Data API로 실제 트래픽 데이터를 조회하고 내부 DB와 교차 분석하여 인사이트를 생성합니다.
---
...
| Content Performance | GA4+DB 교차 분석 | "콘텐츠 성과", "인기 글" |
