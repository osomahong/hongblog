...
const RULES = [
    ...
    { pattern: /(?<![가-힣])갈래(?:로|가|를|는|의|와|도|만|입니다|입니까|이다|이고|이며|였다|였습니다|라는)?(?![가-힣])/g, fix: "가지, 종류, 구분", severity: "HARD", src: "2026-08 사용자 지적, 2026-08-11 조사 결합형 보강, 2026-08-20 서술격 결합형 보강" },
    ...
    { pattern: /손보[아았습는]|손볼|손봅니다|손대[는고며]|손댑니다|손댄|손이 가는|손에 익/g, fix: "고칩니다, 바꿉니다, 익숙해집니다", severity: "HARD", src: "2026-08-15 사용자 지적 (GA4 Edu)" },
